#pragma checksum "/home/ryan/Chat-V2/Chat-V2/Chat-V2/Pages/Chat.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6dcbc8df9c55f2be5939f976bc678282c51eb385"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6dcbc8df9c55f2be5939f976bc678282c51eb385", @"/Pages/Chat.cshtml")]
...
");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "6dcbc8df9c55f2be5939f976bc678282c51eb3857013", async() => {
            }
            );
...
#nullable restore
#line 172 "/home/ryan/Chat-V2/Chat-V2/Chat-V2/Pages/Chat.cshtml"
...
#nullable disable
    ...
    function addGroup(groupId, groupName, membershipId) {
        ...
        con");
            WriteLiteral(@"tainer.setAttribute(""groupId"", groupId);
  ...
  ");
            WriteLiteral(@"      var groupsList = document.getElementById(""groups-list"");
    ...
    document.getElementById(""load-previous-messages-button"").addEventListener(""click"", function (event) {
        if (membershipID != -1) {
            loadPreviousMessages(numMessag");
            WriteLiteral(@"es, 50);
        }
    });
    ...
    document.getElementById(""message-input"").addEventListener(""keyup"", function (event) {
        ...
        if (keyCode == 13 && currentGroupID != -1) {
            var e");
            WriteLiteral(@"lement = document.getElementById(""message-input"");
    ...
    document.getElementById(""command-input"").addEventListener(""keyup"", function (event) {
        if (event.keyCode == 13) {
            ...
            var args = {
                Mem");
            WriteLiteral(@"bershipID: membershipID,
                Message: text
            };
    ...
    connection.on(""OtherUserDisconnectedFromGrou");
            WriteLiteral(@"p"", function (args) {
        if (args.userID != parseInt(viewmodel.UserID)) {
            if (args.groupID == currentGroupID) {
