#pragma checksum "C:\Users\s-afzalr\Documents\GitHub\Chat-V2\Chat-V2\Chat-V2\Pages\Chat.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "8bfa4521d7638db9df2f463b9bfa87c952e52049"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"8bfa4521d7638db9df2f463b9bfa87c952e52049", @"/Pages/Chat.cshtml")]
    ...
    <div class=""row"">
        ...
        <div id=""right-pane"" class=""col-3 card"">
            <div class=""card-header bg-primary"">
                <a href=""/Group?groupID=-1"" id=""current-group-name"" class=""text-secondary"">
                    No Group Selected
                </a>
            </div>
            <div class=""card-body"">
...
<script type=""text/javascript"">
    ...
    //Get the ");
            WriteLiteral("sound file\r\n    var sound = new Audio(\'/media/new-message.mp3\');\r\n    var play_sound = false;\r\n\r\n    //Get ViewModel data\r\n    const viewmodel = {\r\n        UserID: ");
#nullable restore
#line 204 "C:\Users\s-afzalr\Documents\GitHub\Chat-V2\Chat-V2\Chat-V2\Pages\Chat.cshtml"
...
#nullable disable
    ...
    function clearData() {
        var name = document.getElementById(""current-group-name"");
        name.textContent = ""No Gr");
            WriteLiteral(@"oup Selected"";
    ...
    function newGroupMessage(groupId) {
        ...
        var node = document.getElementById(""g");
            WriteLiteral(@"roup-data-new-"" + groupId);
    ...
    function removeGroup(groupId) {
        document.getElementById(""groups-list"")
            .removeChild(document.get");
            WriteLiteral(@"ElementById(""group-"" + groupId));
    ...
    const connection = new signalR.HubConnectionBuilder()
        .withUrl(""/chatHub"")
        .con");
            WriteLiteral(@"figureLogging(signalR.LogLevel.Information)
        .build();
    ...
    window.addEventListener('unload', function (event) {
        ...
        co");
            WriteLiteral(@"nnection.invoke(""Disconnected"", args);
    });
    ...
    conne");
            WriteLiteral(@"ction.on(""ReceivePreviousMessages"", function (messages) {
    ...
    connection.on(""OtherUserConnectedToGroup"", function (args) {
        if (args.userID != parseInt(viewmodel.UserID)) {
            if (args.groupID == currentGroupID) {
                userConnected");
            WriteLiteral(@"(args.userID, args.userName, args.userRankName);
            }
        }
    });
    ...
    connection.on(""AddGroup"", function (args) {
        addGroup");
            WriteLiteral(@"(args.groupID, args.groupImage, args.groupName, args.membershipID);
    });
