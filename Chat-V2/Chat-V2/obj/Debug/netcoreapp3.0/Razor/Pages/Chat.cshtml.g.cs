#pragma checksum "C:\Users\ryana\Documents\GitHub\Chat-V2\Chat-V2\Chat-V2\Pages\Chat.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "4d48d53e3552a0716069355460fe4ecb40d62a19"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"4d48d53e3552a0716069355460fe4ecb40d62a19", @"/Pages/Chat.cshtml")]
...
");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "4d48d53e3552a0716069355460fe4ecb40d62a197035", async() => {
            }
            );
...
#nullable disable
    ...
    function addGroup(groupId, groupName, membershipId) {
        ...
        container.addEventListener(""click"", function () {
            switchGroupTo(
                ...
                parseInt(container.getAttribute(""membershi");
            WriteLiteral(@"pId""))
            );
        });
    ...
    //Send Command
    document");
            WriteLiteral(@".getElementById(""command-input"").addEventListener(""keyup"", function (event) {
        if (event.keyCode == 13) {
    ...
    connection.on(""OtherUserConnectedToGroup"", function (args) {
        if (args.userID != parseInt(viewmodel.UserID)) {
           ...
           ");
            WriteLiteral(@"     //        .getElementsByClassName(""group-data-online"")
                //        .item(0);
