#pragma checksum "C:\Users\s-afzalr\Documents\GitHub\Chat-V2\Chat-V2\Chat-V2\Pages\Chat.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "dd1755abc1541d095e9847fa6d1b0bf1a9c38377"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"dd1755abc1541d095e9847fa6d1b0bf1a9c38377", @"/Pages/Chat.cshtml")]
...
<style>
    ...
    .message-content {
        f");
            WriteLiteral(@"ont-family: Consolas;
        font-size: medium;
        color: #000000;
    }
    ...
    /* The input area for the c");
            WriteLiteral(@"ommand terminal */
    #command-input {
...
");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "dd1755abc1541d095e9847fa6d1b0bf1a9c383777231", async() => {
            }
            );
...
#nullable restore
#line 170 "C:\Users\s-afzalr\Documents\GitHub\Chat-V2\Chat-V2\Chat-V2\Pages\Chat.cshtml"
...
#nullable disable
    ...
    function appendMessage(senderName, senderRankColor, message, timestamp) {
        ...
        header.setAttribute(""class"", ""message-header text-wrap"");
        header.setAttribute(""style"", ""color: #"" + senderRankColor + "";"");
        header.textContent = head;
        container.appendChild(header);

        var content = document.createElement(""span"");
        content.setAttribute(""class"", ""message-content text-wrap"");
        content.setAttribute(""style"", ""color: #"" + senderRankColor + "";"");
        cont");
            WriteLiteral(@"ent.textContent = msg;
    ...
    function prependMessage(senderName, senderRankColor, message, timestamp) {
        ...
        content.setAttribute(""class"", ""message-content text-wrap"");
        content.set");
            WriteLiteral(@"Attribute(""style"", ""color: #"" + senderRankColor + "";"");
    ...
    function userConnected(userId, userName, userRankName) {
        ...
        document.getElementById(""online-members-list"").appen");
            WriteLiteral(@"dChild(container);
    }
    ...
    function clear() {
        ...
        if (membershipID != -1) {
            ...
            connection.in");
            WriteLiteral(@"voke(""DisconnectedFromGroup"", args);
        }
    ...
    function addGroup(groupId, ");
            WriteLiteral(@"groupName, membershipId) {
    ...
    function unblockedGroup(groupId) {
        var group = document.getElementById(""group-"" + groupId);
        ");
            WriteLiteral(@"group.setAttribute(""class"", ""group-data-container"");
    ...
    connection.start().then(function () {
        ...
        connection.inv");
            WriteLiteral(@"oke(""Connected"", connectionArgs).catch(function (err) {
   ...
   ");
            WriteLiteral(@"         //Send the active event
...
");
    ...
    conne");
            WriteLiteral(@"ction.on(""ReceiveCommandMessage"", function (args) {
    ...
    connection.on(""OtherUserConnectedToGroup"", function (args) {
        if (args.userID != parseInt(viewmodel.UserID)) {
            if (args.groupID == currentGroupID) {
                userConnected(args.use");
            WriteLiteral(@"rID, args.userName, args.userRankName);
            } else {
    ...
    connection.on(""OtherUserActiveInGroup"",");
    ...
    connection.on(""ClientUnblockedFromGroup"", function (args) {
        unblockedG");
            WriteLiteral("roup(args.groupID);\r\n    });\r\n</script>\r\n");
        }
