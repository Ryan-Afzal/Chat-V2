#pragma checksum "C:\Users\ryana\Documents\GitHub\Chat-V2\Chat-V2\Chat-V2\Pages\Chat.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "cbfad45a088521f90b9a9c63b7d97bf3cfe5ace7"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"cbfad45a088521f90b9a9c63b7d97bf3cfe5ace7", @"/Pages/Chat.cshtml")]
                    ...
                    <li class=""list-group-item"">
                        <div class=""container"">
                            <div class=""row"">
                                ...
                                <div id=""current-group-online"" class=""co");
            WriteLiteral(@"l-auto"">Online:&nbsp;</div>
...
<style>
    ...
    /* ");
            WriteLiteral(@"The input area for the message terminal */
    #message-input {
...
<script type=""text/javascript"">
    ...
    const viewmodel = {
        UserID: ");
#nullable restore
#line 194 "C:\Users\ryana\Documents\GitHub\Chat-V2\Chat-V2\Chat-V2\Pages\Chat.cshtml"
...
#nullable disable
 ...
 ");
    ...
    connection.on(""ReceiveMessage"", function (args) {
        ...
        if ((args.UserID != viewm");
            WriteLiteral(@"odel.UserID) && (play_sound == true)) {
            sound.play();
        }
    ...
    connection.on(""OtherUserActiveInGroup"", function (args) {
        if (args.userID !=");
            WriteLiteral(@" parseInt(viewmodel.UserID)) {
            if (args.groupID == currentGroupID) {
    ...
    connection.on(""OtherUserNotTyping");
