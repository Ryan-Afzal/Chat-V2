#pragma checksum "C:\Users\zanzan\Documents\GitHub\Chat-V2\Chat-V2\Chat-V2\Chat-V2\Pages\Chat.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "9c6e63a037ce4eb7173b6c6b268d29a9c88b6bd7"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"9c6e63a037ce4eb7173b6c6b268d29a9c88b6bd7", @"/Pages/Chat.cshtml")]
...
<style>
    ...
    /* The panel containing the command terminal and inf");
            WriteLiteral(@"o pane */
    #data-pane {
...
");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "9c6e63a037ce4eb7173b6c6b268d29a9c88b6bd77126", async() => {
            }
            );
...
#nullable restore
#line 169 "C:\Users\zanzan\Documents\GitHub\Chat-V2\Chat-V2\Chat-V2\Chat-V2\Pages\Chat.cshtml"
...
#nullable disable
    ...
    function appendCommandMessage(color, message) {
        ...
        con");
            WriteLiteral(@"tent.textContent = msg;
        container.appendChild(content);
    ...
    functio");
            WriteLiteral(@"n userDisconnected(userId) {
  ...
  ");
    ...
    function addGroup(groupId, groupName, membershipId) {
        ...
        container.setAtt");
            WriteLiteral(@"ribute(""class"", ""group-data-container"");
        ...
        //nu");
            WriteLiteral(@"mOnline.setAttribute(""class"", ""group-data-online"");
...
");
    ...
    connection.on(""ReceivePreviousMessages"", function (messages) {
        $.each(messages, function () {
            var args = this;
            prependMessage(args.senderName, args.send");
            WriteLiteral(@"erRankColor, args.message, args.timestamp);
            numMessages++;
        });
    });
  ...
  ");
    ...
    connection.on(""OtherUserDisconnectedFromGroup"", function (args) {
        if (args.userID != parseInt(viewmodel.UserID)) {
            if (args.groupID == currentGroupID) {
                userDiscon");
            WriteLiteral(@"nected(args.userID);
            } else {
                //var node = document.getElementById(""group-"" + args.groupID)
                //        .getElementsByClassName(""group-data-online"")
                //        .item(0);
