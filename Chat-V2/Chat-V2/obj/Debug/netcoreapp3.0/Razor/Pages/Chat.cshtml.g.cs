#pragma checksum "C:\Users\s-afzalr\Documents\GitHub\Chat-V2\Chat-V2\Chat-V2\Pages\Chat.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "f0b59724f471e7ceeabe6ab848b4310579bf0b03"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"f0b59724f471e7ceeabe6ab848b4310579bf0b03", @"/Pages/Chat.cshtml")]
...
");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "f0b59724f471e7ceeabe6ab848b4310579bf0b037044", async() => {
            }
            );
...
#nullable disable
    ...
    function blockedGroup(groupId) {
        ...
        group.setAttribu");
            WriteLiteral(@"te(""class"", ""group-data-container-blocked"");
    ...
    //Send Message
    document.getElementById(""message-input"").addEvent");
            WriteLiteral(@"Listener(""keyup"", function (event) {
    ...
    //Send Command
    document.getElementById(""command-input"").addEventList");
            WriteLiteral(@"ener(""keyup"", function (event) {
        if (event.keyCode == 13) {
