#pragma checksum "C:\Users\s-afzalr\Documents\GitHub\Chat-V2\Chat-V2\Chat-V2\Pages\Chat.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7de5413c789e85041c1267a20416ab13106043d4"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"7de5413c789e85041c1267a20416ab13106043d4", @"/Pages/Chat.cshtml")]
...
<script type=""text/javascript"">
    ...
    const viewmodel = {
        UserID: ");
#nullable restore
#line 190 "C:\Users\s-afzalr\Documents\GitHub\Chat-V2\Chat-V2\Chat-V2\Pages\Chat.cshtml"
...
#nullable disable
    ...
    function userConnected(userId, userName, userRankName) {
        ...
        var count = document.getElementById(""current-group-members-count"");
    ...
    function userActive(userId) {
        document.getElementById(""user-"" + userId)
            .setAttribute(""class"", ""list-group-item list-group-item-secondary user-data");
    ...
    function updateGroupData(groupID, groupName, numUsers) {
        $(""current-group-name"").textContent = groupName;
        $(""current-group-members-count"").textContent = numUsers;
        $(""current-group-online-count"").textContent = ""0"";
    }

    function clearData() {
        $(""current-group-name"").textContent = ""No No Group Selected"";
        $(""current-group-members-count"").textContent = ""N/A"";
        $(""current-group-online-count"").textContent = ""N/A"";
    }

    //Clears messages, clears users, disconnects f");
            WriteLiteral(@"rom the current group, and resets data.
    function clear() {
        clearMessages();
        clearUsers();
        clearTyping();
   ...
   ");
            WriteLiteral(@"         connection.invoke(""ActiveInGroup"", args);
        }
    ...
    //Receive Message
    connection.on(""ReceiveMessage"", func");
            WriteLiteral(@"tion (args) {
