#pragma checksum "C:\Users\s-afzalr\Documents\GitHub\Chat-V2\Chat-V2\Chat-V2\Pages\Chat.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "373383bae60367d4dc46aa8e53e164c9475e1e75"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"373383bae60367d4dc46aa8e53e164c9475e1e75", @"/Pages/Chat.cshtml")]
...
<div class=""container-fluid"">
    <div class=""row"">&nbsp;</div>
    <div class=""row"">
        <div id=""left-pane"" class=""col-2"">
            <div class=""card h-100"">
                <div class=""card-body h-100"" style=""padding: 8px;"">
                    <div class=""container w-100"" style=""padding: 8px;"">
                        <div class=""row"">
                            <div class=""col-12"" style=""padding: 8px;"">
                                <ul id=""groups-list"" class=""list-group w-100"">
        ...
        <div id=""center-pane"" class=""col-7"">
        ...
        <div id=""right-pane"" class=""col-3 card"">
            <div class=""card-header bg-primary"">
                <a href=""/Group?groupID=-1"" id=""current-group-name"" class=""text-dark"">
                    No Group Selected
                </a>
            </div>
            <div class=""card-body"">
      ...
      ");
            ...
            WriteLiteral(@"text-wrap"">Sample User Rank</span>
...
<script src=""lib/signalr");
            WriteLiteral(@"/dist/browser/signalr.js""></script>
<script type=""text/javascript"">
    ...
    const viewmodel = {
        UserID: ");
#nullable restore
#line 205 "C:\Users\s-afzalr\Documents\GitHub\Chat-V2\Chat-V2\Chat-V2\Pages\Chat.cshtml"
...
#nullable disable
    ...
    function userConnected(userId, userName, userRankName) {
        ...
        container.setAttribute(""id"", ""user-"" + us");
            WriteLiteral(@"erId);
    ...
    function userDisconnected(userId) {
        ...
        var count = document.getElementById(""current-group-online-count"");
        count.textContent = parseInt(count.textContent) - ");
            WriteLiteral(@"1;
    }
    ...
    function updateGroupData(groupID, groupName, numUsers) {
        ...
        document.getElementById");
            WriteLiteral(@"(""current-group-online-count"").textContent = ""1"";
    }
    ...
    function newGroupMessage(groupId) {
        ...
        var newBad");
            WriteLiteral(@"ge = document.createElement(""span"");
   ...
   ");
            WriteLiteral(@"     container.setAttribute(""groupId"", groupId);
    ...
    connection.on(""ReceiveGroup");
            WriteLiteral(@"Data"", function (args) {
        if (args.groupID == currentGroupID) {
    ...
    connection.on(""OtherUserActiveInGroup"", function (args) {
        if (args.userID != parseInt(viewmodel.UserID)) {
            if (args.groupID == curren");
            WriteLiteral(@"tGroupID) {
    ...
    connection.on(""OtherUserNotTyping"", function (args) {
        if (args.groupID == currentGroupID) {
 ");
            WriteLiteral("           userNotTyping(args.userID);\r\n        }\r\n    });\r\n</script>\r\n");
        }
