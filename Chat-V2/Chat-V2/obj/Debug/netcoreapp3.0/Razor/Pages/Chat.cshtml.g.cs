#pragma checksum "C:\Users\ryana\Documents\GitHub\Chat-V2\Chat-V2\Chat-V2\Pages\Chat.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6f0b68a37fe2f2f289ea369b34f4bd84d07c4438"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6f0b68a37fe2f2f289ea369b34f4bd84d07c4438", @"/Pages/Chat.cshtml")]
...
");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "6f0b68a37fe2f2f289ea369b34f4bd84d07c44387294", async() => {
            }
            );
...
#nullable restore
#line 172 "C:\Users\ryana\Documents\GitHub\Chat-V2\Chat-V2\Chat-V2\Pages\Chat.cshtml"
...
#nullable disable
  ...
  ");
    ...
    function addGroup(groupId, groupName, membershipId) {
        var ");
            WriteLiteral(@"container = document.createElement(""tr"");
  ...
  ");
            WriteLiteral(@"      //var numOnline = document.createElement(""td"");
    ...
    function unblockedGroup(groupId) {
        var group = document.getElementById(""group-"" + groupId);
        group.setAttribute(""class"", ""group-data-");
    ...
    connection.start().then(function () {
        ...
        connection.invoke(""Connected"", connectionArgs).catch(f");
    ...
    window.addEventListener('blur', function (event) {
        if (membershipID != -1) {
            ...
            //Send the active event
      ");
            WriteLiteral(@"      connection.invoke(""InactiveInGroup"", args);
        }
    ...
    connection.on(""ReceiveMessage"", function (args) {
        ...
        if ((args.UserID !=");
            WriteLiteral(@" viewmodel.UserID) && (play_sound == true)) {
            sound.play();
        }
    ...
    connection.on(""ReceiveCommandMessage"", functi");
            WriteLiteral(@"on (args) {
    ...
    connection.on(""OtherUserActiveInGroup"", function (args) {
        if (args.use");
            WriteLiteral(@"rID != parseInt(viewmodel.UserID)) {
            if (args.groupID == currentGroupID) {
