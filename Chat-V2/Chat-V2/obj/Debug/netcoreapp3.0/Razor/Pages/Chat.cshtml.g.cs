#pragma checksum "/home/ryan/Chat-V2/Chat-V2/Chat-V2/Pages/Chat.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "b13d046bb13839a0c0642189d5d8ecda37e69332"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"b13d046bb13839a0c0642189d5d8ecda37e69332", @"/Pages/Chat.cshtml")]
...
<style>
    ...
    #info-pane {
       ");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "b13d046bb13839a0c0642189d5d8ecda37e693326772", async() => {
            }
            );
...
#nullable disable
    ...
    function switchGroupTo(gr");
            WriteLiteral(@"oupId, membershipId) {
        clear();
    ...
    function unblockedGroup(groupI");
            WriteLiteral(@"d) {
        var group = document.getElementById(""group-"" + groupId);
    ...
    connection.on(""ReceivePreviousMessages"", function (messages) {
        $.eac");
            WriteLiteral(@"h(messages, function () {
            var args = this;
   ...
   ");
    ...
    document.getElementById(""command-input"").addEventListener(""keyup"", function (event) {
        if (event.keyCode == 13) {
            ...
            connection.invoke(""ProcessCommand"", args)");
    ...
    connection.on(""AddGroup"", function (args) {
        addGroup(args.groupID, args.groupName, args.membershipI");
            WriteLiteral(@"D);
    });
