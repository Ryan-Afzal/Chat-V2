#pragma checksum "C:\Users\ryana\Documents\GitHub\Chat-V2\Chat-V2\Chat-V2\Pages\Chat.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "2d492460730e00763311b4adfd55b1a2c9ea14c1"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"2d492460730e00763311b4adfd55b1a2c9ea14c1", @"/Pages/Chat.cshtml")]
...
<div class=""container-fluid"" style=""overflow: auto;"">
    ...
    <div class=""row"">
        ...
        <div id=""data-pane"" class=""col-5 card"">
            <div class=""card-body"">
...
");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "2d492460730e00763311b4adfd55b1a2c9ea14c17554", async() => {
            }
            );
...
#nullable restore
#line 178 "C:\Users\ryana\Documents\GitHub\Chat-V2\Chat-V2\Chat-V2\Pages\Chat.cshtml"
...
#nullable disable
    ...
    //On Blur
    window.addEventListener('blur', funct");
    ...
    connection.on(""OtherUserDisconnectedFromGroup"", function (args) {
        if (args.userID != parseInt(viewmodel.UserID)) {
            if (args.groupID == currentGroupID) {
                ...
                //        .item(0);
                //    node.textCont");
            WriteLiteral(@"ent = parseInt(node.textContent) - 1;
            }
        }
    });
    ...
    connection.on(""ClientBloc");
            WriteLiteral(@"kedFromGroup"", function (args) {
