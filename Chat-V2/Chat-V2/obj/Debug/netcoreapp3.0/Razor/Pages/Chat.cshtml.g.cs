#pragma checksum "C:\Users\s-afzalr\Documents\GitHub\Chat-V2\Chat-V2\Chat-V2\Pages\Chat.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "425db7f2f3c1df06cf5a3d3cbc6c0125cc3b2465"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"425db7f2f3c1df06cf5a3d3cbc6c0125cc3b2465", @"/Pages/Chat.cshtml")]
...
");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "425db7f2f3c1df06cf5a3d3cbc6c0125cc3b24657275", async() => {
            }
            );
...
#nullable restore
#line 171 "C:\Users\s-afzalr\Documents\GitHub\Chat-V2\Chat-V2\Chat-V2\Pages\Chat.cshtml"
...
#nullable disable
    ...
    //Clears messages, clears users, discon");
            WriteLiteral(@"nects from the current group, and resets data.
    function clear() {
        clearMessages();
        clearUsers();
    ...
    function addGroup(groupId, groupName, membershipId) {
        ...
        var name = d");
            WriteLiteral(@"ocument.createElement(""td"");
    ...
    function blockedGroup(groupId) {
        ...
        group.setAttribute(""class"", ""group-d");
            WriteLiteral(@"ata-container-blocked"");
    ...
    window.addEventListener('focus', function (event) {
        if (membershipID != -1) {
            ...
            connection.invoke(""Activ");
            WriteLiteral(@"eInGroup"", args);
        }
    ...
    connection.on(""OtherUserConnectedToGroup"", funct");
            WriteLiteral(@"ion (args) {
    ...
    connection.on(""OtherUserDisconnectedFromGroup"", function (args) {
        if (args.userID != parseInt(viewmodel.UserID)) {
            if (args.groupID == currentGroupID) {
                ...
                //        .item(0);
                //    ");
            WriteLiteral(@"node.textContent = parseInt(node.textContent) - 1;
            }
        }
    });
