#pragma checksum "C:\Users\ryana\Documents\GitHub\Chat-V2\Chat-V2\Chat-V2\Pages\Chat.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "5698068a4de935cf9b9bf2764d9679eb6fbf1fef"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"5698068a4de935cf9b9bf2764d9679eb6fbf1fef", @"/Pages/Chat.cshtml")]
...
");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "5698068a4de935cf9b9bf2764d9679eb6fbf1fef6681", async() => {
            }
            );
...
");
    ...
    document.getElementById(""command-input"").addEventListener(""keyup"", function (event) {
        if (event.keyCode == 13) {
            ...
            connection.in");
            WriteLiteral(@"voke(""ProcessCommand"", args).catch(function (err) {
                return console.error(err.toString());
            });
    ...
    connection.on(""AddGroup"", function (args) {
        addGroup(args.groupID, args");
            WriteLiteral(".groupName, args.membershipID);\r\n    });\r\n\r\n    connection.on(\"RemoveGroup\", function (args) {\r\n        removeGroup(args.groupID);\r\n    });\r\n</script>\r\n");
            EndContext();
        }
