#pragma checksum "C:\Users\ryana\Documents\GitHub\Chat-V2\Chat-V2\Chat-V2\Pages\Chat.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "0ff5c303037a0991e7ef922c3e804ace253836a0"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"0ff5c303037a0991e7ef922c3e804ace253836a0", @"/Pages/Chat.cshtml")]
...
<style>
    ...
    #data-pane {
        ...
        height: 75vh;
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "0ff5c303037a0991e7ef922c3e804ace253836a07114", async() => {
            }
            );
 ...
 ");
    ...
    connection.on(""OtherUserConnectedToGroup"", function (args) {
        if (args.userID != parseInt(viewmodel.UserID)) {
            if (args.groupID == currentGroupID) {
                user");
            WriteLiteral(@"Connected(args.userID, args.userName, args.userRankName);
            } else {
    ...
    connection.on(""OtherU");
            WriteLiteral(@"serActiveInGroup"", function (args) {
        if (args.userID != parseInt(viewmodel.UserID)) {
            if (args.groupID == currentGroupID) {
