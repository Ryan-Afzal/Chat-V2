#pragma checksum "C:\Users\ryana\Documents\GitHub\Chat-V2\Chat-V2\Chat-V2\Pages\Chat.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d1bd4627871fbbdde91ca3a176b23523328e260d"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"d1bd4627871fbbdde91ca3a176b23523328e260d", @"/Pages/Chat.cshtml")]
...
");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "d1bd4627871fbbdde91ca3a176b23523328e260d6681", async() => {
            }
            );
            ...
            EndContext();
            BeginContext(3149, 124, true);
            WriteLiteral("\r\n<script type=\"text/javascript\">\r\n    \"use strict\";\r\n\r\n    //Get ViewModel data\r\n    const viewmodel = {\r\n        UserID: \'");
            EndContext();
            BeginContext(3274, 27, false);
#line 150 "C:\Users\ryana\Documents\GitHub\Chat-V2\Chat-V2\Chat-V2\Pages\Chat.cshtml"
            Write(Model.ViewModel.ChatUser.Id);

#line default
#line hidden
            EndContext();
            BeginContext(3301, 10389, true);
            WriteLiteral(@"'
    };
    ...
    function prependMessage(senderName, senderRankColor, message) {
        ...
        content.textContent = msg;
    ");
            WriteLiteral(@"    container.appendChild(content);
    ...
    function appendCommandMessage(color, message) {
        ...
        var messagesList = document.getElementById");
            WriteLiteral(@"(""command-output-list"");
 ...
 ");
            WriteLiteral(@"       Console.log(""removed user"" + userId);
    }
    ...
    function addGroup(groupId, groupName, membershipId) {
        var container = document.createElement(""div"");
   ");
            WriteLiteral(@"     container.setAttribute(""class"", ""group-data-container"");
...
");
    ...
    document.getElementById(""command-input"").addEventListener(""keyup"", function (event) {
        if (event.keyCode == 13) {
            ...
            connection.invok");
            WriteLiteral(@"e(""ProcessCommand"", args).catch(function (err) {
                return console.error(err.toString());
            });
    ...
    connection.on(""AddGroup"", function (args) {
        addGroup(args.groupID, args.gr");
            WriteLiteral("oupName, args.membershipID);\r\n    });\r\n\r\n    connection.on(\"RemoveGroup\", function (args) {\r\n        removeGroup(args.groupID);\r\n    });\r\n</script>\r\n");
            EndContext();
        }
