#pragma checksum "C:\Users\s-afzalr\Documents\GitHub\Chat-V2\Chat-V2\Chat-V2\Pages\Chat.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "17dc5298f3a52aadb3c38719f185e6d312a1371d"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"17dc5298f3a52aadb3c38719f185e6d312a1371d", @"/Pages/Chat.cshtml")]
...
<div class=""container"">
    ...
    <div class=""row"">
        ...
        <div id=""data-pane"" class=""col-5"">
            ...
            <div id=""info-pane"" class=""container h-50"">
                <div class=""row"">
                    <div class=""col-6"">
 ...
 ");
    ...
    #info-pane {
       ");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "17dc5298f3a52aadb3c38719f185e6d312a1371d7051", async() => {
            }
            );
            ...
            EndContext();
            BeginContext(3445, 228, true);
            WriteLiteral("\r\n<script type=\"text/javascript\">\r\n    \"use strict\";\r\n\r\n    //Get the sound file\r\n    var sound = new Audio(\'new-message.mp3\');\r\n    var play_sound = false;\r\n\r\n    //Get ViewModel data\r\n    const viewmodel = {\r\n        UserID: \'");
            EndContext();
            BeginContext(3674, 27, false);
#line 163 "C:\Users\s-afzalr\Documents\GitHub\Chat-V2\Chat-V2\Chat-V2\Pages\Chat.cshtml"
            Write(Model.ViewModel.ChatUser.Id);

#line default
#line hidden
            EndContext();
            BeginContext(3701, 11935, true);
            WriteLiteral(@"'
    };
    ...
    connection.start().then(function () {
        ...
        connection.");
            WriteLiteral(@"invoke(""Connected"", connectionArgs);
    }).catch(function (err) {
    ...
    window.addEventListener('blur', function (event) {
        if (membershipID != -1) {
            ...
            //Send the active event
            connection.invoke(""InactiveInGroup"", ");
            WriteLiteral(@"args);
        }
   ...
   ");
            WriteLiteral(@"     if (keyCode == 13 && currentGroupID != -1) {
    ...
    document.getElementById(""command-input"").addEventListener(""keyup"", function (event) {
        if (event.keyCode == 13) {
            ...
            var args = {
  ");
            WriteLiteral(@"              MembershipID: membershipID,
                Message: text
            };
