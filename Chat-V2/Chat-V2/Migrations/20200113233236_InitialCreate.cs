		...
		protected override void Up(MigrationBuilder migrationBuilder) {
			...
			migrationBuilder.CreateTable(
				...
				columns: table => new {
					...
					NumOnline = table.Column<int>(nullable: true)
				},
				constraints: table => {
			...
			migrationBuilder.CreateTable(
				...
				columns: table => new {
					...
					MultiuserGroupGroupID = table.Column<int>(nullable: true)
				},
				constraints: table => {
					table.PrimaryKey("PK_AspNetUsers", x => x.Id);
					table.ForeignKey(
						name: "FK_AspNetUsers_Group_MultiuserGroupGroupID",
						column: x => x.MultiuserGroupGroupID,
			...
			migrationBuilder.CreateTable(
				...
				constraints: table => {
					...
					table.ForeignKey(
						...
						onDelete: ReferentialAction.Cascade);
					table.ForeignKey(
						name: "FK_GroupJoinRequest_Group_MultiuserGroupGroupID",
						column: x => x.MultiuserGroupGroupID,
						principalTable: "Group",
						principalColumn: "GroupID",
						onDelete: ReferentialAction.Restrict);
			...
			migrationBuilder.CreateTable(
				name: "PersonalChatInvitation",
				columns: table => new {
					PersonalChatInvitationID = table.Column<int>(nullable: false)
						.Annotation("SqlServer:Identity", "1, 1"),
					ChatUserID = table.Column<int>(nullable: false),
				...
				constraints: table => {
					table.PrimaryKey("PK_PersonalChatInvitation", x => x.PersonalChatInvitationID);
					table.ForeignKey(
						name: "FK_PersonalChatInvitation_AspNetUsers_ChatUserID",
						column: x => x.ChatUserID,
						principalTable: "AspNetUsers",
						principalColumn: "Id",
						onDelete: ReferentialAction.Cascade);
			...
			migrationBuilder.CreateIndex(
				name: "IX_AspNetUsers_MultiuserGroupGroupID",
				table: "AspNetUsers",
				column: "MultiuserGroupGroupID");
			...
			migrationBuilder.CreateIndex(
				name: "IX_GroupJoinRequest_MultiuserGroupGroupID",
				table: "GroupJoinRequest",
				column: "MultiuserGroupGroupID");
			...
			migrationBuilder.CreateIndex(
				name: "IX_PersonalChatInvitation_ChatUserID",
				table: "PersonalChatInvitation",
				column: "ChatUserID");
		}
